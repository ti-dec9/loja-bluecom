...
<body>
    ...
    <div class="slider-area">
        <div class="hero-slider-wrapper">
            <!-- Single Slider  -->
            <div class="single-slide slider-height-1 bg-img d-flex" data-bg-image="http://www.bluecom.com.br/lojabluecom/storage/2020/01/Bluecom_Landing_Transcend.jpg">
                <div class="container align-self-center">
                    <div class="slider-content-1 slider-animated-1 text-left pl-60px">
                        <img src="http://www.bluecom.com.br/lojabluecom/storage/2020/01/1-escudo_Transcend.png">
                        <p class="animated color-gray">Conheça nossa linha de produtos.</p>
                        <a href="#" class="shop-btn animated">Saiba Mais</a>
                    </div>
                </div>
            </div>
            <!-- Single Slider  -->
            <div class="single-slide slider-height-1 bg-img d-flex" data-bg-image="http://www.bluecom.com.br/lojabluecom/storage/2020/01/Bluecom_Landing_GTS.jpg">
                <div class="container align-self-center">
                    <div class="slider-content-1 slider-animated-2 text-left pl-60px">
                        <img src="http://www.bluecom.com.br/lojabluecom/storage/2020/01/1-escudo_GTS.png">
                        <p class="animated color-gray">Lorem ipsum</p>
                        <a href="#" class="shop-btn animated">Saiba Mais</a>
                    </div>
                </div>
            </div>
            <!-- Single Slider  -->
            <div class="single-slide slider-height-1 bg-img d-flex" data-bg-image="http://www.bluecom.com.br/lojabluecom/storage/2020/01/Bluecom_Landing_Hercules.jpg">
                <div class="container align-self-center">
                    <div class="slider-content-1 slider-animated-3 text-left pl-60px">
                        <img src="http://www.bluecom.com.br/lojabluecom/storage/2020/01/1-escudo_hercules.png" alt="">
                        <p class="animated color-gray">Lorem ipsum</p>
                        <a href="#" class="shop-btn animated">Saiba Mais</a>
                    </div>
                </div>
    ...
    <!-- Arrivals Area Start -->
    <div class="arrival-area mt-50px mb-20px">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        ...
                        <ul class="nav nav-tabs sub-category">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab-3">Fibra Óptica</a>
                            </li>
                        </ul>
                        <!-- Nav tabs -->
                    </div>
    ...
    <!-- Brand area start -->
    <div class="brand-area mt-20px mb-50px">
        <div class="container">
    ...
    <div class="popular-categories-area mt-50px mb-50px">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="section-heading">Categoria de Produtos</h2>
                    </div>
                </div>
            </div>
